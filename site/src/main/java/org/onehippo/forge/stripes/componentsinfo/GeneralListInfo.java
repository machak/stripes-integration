...
package org.onehippo.forge.stripes.componentsinfo;
...
public interface GeneralListInfo  {
    ...
    @Parameter(name = "docType", defaultValue="stripesintegration:basedocument", displayName = "Document Type", typeHint = ComponentWrapper.ParameterType.STRING)
    String getDocType();
